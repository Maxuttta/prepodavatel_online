...
class videos_activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = CardAdapter(this@videos_activity) // <-- Инициализация адаптера
    ...
    private fun loadCards() {
        dbRef = FirebaseDatabase.getInstance().getReference("Online").child("videos")
